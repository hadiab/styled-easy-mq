...
var getFacepaint = function (breakpoints) { return facepaint(breakpoints.map(function (bp) { return getMedia(bp); })); };
...
var createMediaQuery = function (breakpoints) {
    ...
    var facepaint = getFacepaint(breakpoints);
    return function (style) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        return facepaint(getCssObject.apply(void 0, __spreadArray([style], args)));
    };
};
...
var createCss = function (css, breakpoints) {
    ...
    return function (style) {
        ...
        return css(facepaint(getCssObject.apply(void 0, __spreadArray([style], args))));
    };
};
