...
var createMediaQuery = function (options) {
    ...
    var makeStyle = function (style, options) {
        if (options && options.css && typeof options.css === "function") {
            return options.css(facepaintMQ(style));
        }
    ...
    var mq = function (style) {
        ...
        if (Array.isArray(style)) {
            ...
            return makeStyle(cssObj, undefined);
        }
        return makeStyle(style, initOptions.css ? initOptions : undefined);
    };
    return mq;
};
